# bugs
[ready to test] regular android: at "new game" "you may start on any level..." screen: the numbers-only keyboard wasn't filling the text box even though backspace sometimes worked
