...
1. Prerequisite: wait for or rebase onto the free-space-check centralization work.
...
2. Add durable extraction helper.
...
3. Trigger extraction on import for large mission ZIPs.
...
5. Use durable extraction for launch.
...
6. Use durable extraction for metadata.
...
7. Show linked files in Storage Inspector.
...
8. Tests and verification.
   ...
   - Storage test: linked extracted files are annotated with their owner.
