...
- [ ] Add one shared restore-count function taking the D1/D2 game tag
- [ ] Replace both duplicate count blocks with one call
- [ ] Preserve connected-state predicates, max-only updates, connected assignment, and coop-only log fields
- [ ] Run scoped code quality and diff checks
- [ ] Build all Android ABIs and Windows D1/D2
- [ ] Record the exact reduction and mark the remaining mechanical queue endpoint
