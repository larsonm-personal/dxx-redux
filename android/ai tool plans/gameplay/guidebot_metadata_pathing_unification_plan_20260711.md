...
- [ ] Phase 0 in progress: freeze corpus comparisons and characterize current live behavior.
  ...
  - Phase 6 now has player-assisted switch and hidden-door fixtures; additional
...
- [x] Phase 4 complete: separate canonical and live plans and bridge Guide-Bot to shared C++ output.
  ...
  - [ ] Remaining Phase 6 coverage: blastable-wall semantics and player-assisted boss, reactor, and exit completion. These remain passive player actions and must not alter classic Guide-Bot movement, steering, orientation, flare behavior, or RNG use.
