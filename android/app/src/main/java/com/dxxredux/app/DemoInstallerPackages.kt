...
object DemoInstallerPackages {
    ...
    val knownPackages =
        listOf(
            ...
            PackageInfo(
                filename = "Descent_demo.HQX",
                sha256 = "e485a1570cb6079d3ec55a52ed9150792f5ef450b653e5db9748a305fed2dfe4",
                label = "D1 Demo (Mac)",
                game = "d1",
                extraction = "BinHex-wrapped classic StuffIt archive with direct game data files",
                expectedFiles = listOf("descent.hog", "descent.pig"),
            ),
            PackageInfo(
                filename = "descent_demo.sit_.hqx",
            ...
            PackageInfo(
                filename = "descent2preview.sit",
                sha256 = "5b9c359e47e4e458f655ef5a28e6110ea1deee60d79a08f7ebdb2144ec9263fd",
                label = "D2 Demo (Mac)",
                game = "d2",
                extraction = "classic StuffIt archive with direct game data files",
                expectedFiles = listOf("d2demo.hog", "d2demo.ham", "d2demo.pig", "descent2.s11", "exit.ham"),
            ),
            PackageInfo(
                filename = "descent2preview.sit_.hqx",
