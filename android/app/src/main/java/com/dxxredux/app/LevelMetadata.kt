...
internal data class LevelMetadataLevelRow(
    ...
    val hostages: Int,
    val secrets: Int,
    val secretAreasComplete: Boolean = false,
    val matcens: Int,
    ...
    val routeRequiredKeyMask: Int = 0,
    val routeCompletingKeyMaskSet: Int = 0,
                    ...
                    for (index in 0 until levels.length()) {
                        ...
                        add(
                            LevelMetadataLevelRow(
                                ...
                                segmentCount = row.optInt("segment_count"),
                                wallCount = row.optInt("wall_count"),
                                ...
                                secretAreasComplete = row.optBoolean("secret_areas_complete", false),
                                ...
                                routeRequiredKeyMask = row.optInt("route_required_key_mask"),
                                routeCompletingKeyMaskSet = row.optInt("route_completing_key_mask_set"),
...
internal object LevelMetadataAnalyzer {
    ...
    internal fun buildRobotPreviewRequestJson(
        ...
        buildPreparedRequestJson(target, requestId, workDir, "dxx-robot-preview-request-v1")
            ...
            .put("robot_numbers", JSONArray(robotNumbers))
            .put("preview_write_dir", previewWriteDir.absolutePath)
        ...
        for (index in 0 until array.length()) {
            ...
            add(
                LevelMetadataRouteStep(
                    ...
                    requiredWeapon = step.optString("required_weapon"),
