...
object TouchBindings {
    ...
    const val META_GUIDE_RECALL = 1045
    ...
    val META_BUTTON_LABELS: Map<Int, String> =
        linkedMapOf(
            ...
            META_GUIDE_FIND_UNEXPLORED to "GB: Unexplored",
            META_GUIDE_RECALL to "GB: Recall to Ship",
        ...
        mapOf(
            ...
            "Guide" to
                listOf(
                    ...
                    RadialSegment("Recall", META_GUIDE_RECALL),
                ),
        )
    ...
    val CHEATS_D2 =
        listOf(
            // D2 also accepts motherlode/currygoat/zingermans/eatangelos/
            // ericaanne/joshuaakira/whammazoom for this same lamer effect.
            CheatDef("gabbagabbahey", "Set shields and energy to 1"),
            CheatDef("honestbob", "All weapons and ammo"),
            CheatDef("algroove", "All keys"),
            CheatDef("alifalafel", "Headlight, afterburner, ammo rack, converter"),
            CheatDef("almighty", "Toggle invulnerability"),
            CheatDef("blueorb", "Set shields to max"),
            CheatDef("delshiftb", "Collect powerups, kill robots, blow reactor, move to exit"),
            CheatDef("flash", "Mark path to exit"),
            CheatDef("freespace", "Warp to level"),
            CheatDef("rockrgrl", "Full automap"),
            CheatDef("astral", "Toggle ghost physics"),
            CheatDef("wildfire", "Toggle rapid fire"),
            CheatDef("duddaboo", "Toggle bouncing weapons"),
            CheatDef("buggin", "Toggle turbo mode"),
            CheatDef("imagespace", "Toggle robot firing"),
            CheatDef("spaniard", "Kill robots; repeats can kill buddy"),
            CheatDef("silkwing", "Toggle robots attack robots"),
            CheatDef("godzilla", "Toggle ramming damage boost"),
            CheatDef("helpvishnu", "Spawn extra Guide-Bot"),
            CheatDef("gowingnut", "Toggle angry Guide-Bot"),
            CheatDef("bittersweet", "Toggle psychedelic walls"),
        )

    val CHEATS_D1 =
        listOf(
            CheatDef("gabbagabbahey", "Enable cheat codes"),
            CheatDef("scourge", "All standard weapons and ammo"),
            CheatDef("bigred", "All weapons and ammo"),
            CheatDef("mitzi", "All keys"),
            CheatDef("racerx", "Toggle invulnerability"),
            CheatDef("guile", "Toggle cloak"),
            CheatDef("twilight", "Set shields to max"),
            CheatDef("poboys", "Collect powerups, kill robots, blow reactor, move to exit"),
            CheatDef("flash", "Mark path to exit"),
            CheatDef("farmerjoe", "Warp to level"),
            CheatDef("bruin", "Extra life"),
            CheatDef("astral", "Toggle ghost physics"),
            CheatDef("porgys", "Mega weapons, 200 shields and energy"),
            CheatDef("buggin", "Toggle turbo mode"),
            CheatDef("ahimsa", "Toggle robot firing"),
            CheatDef("bittersweet", "Toggle psychedelic walls"),
        )
}
