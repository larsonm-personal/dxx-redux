...
object TouchLayoutRepository {
    ...
    fun presetAdvanced() =
        TouchLayout(
            ...
            buttons =
                listOf(
                    ...
                    ButtonControl(
                        ...
                        xPct = 95f,
                        yPct = 35f,
                        binding = TouchBindings.BTN_FIRE_FLARE,
                        label = "F",
                        sizeMult = 0.7f,
                    ),
                    ButtonControl(
                    ...
                    ButtonControl(
                        ...
                        xPct = 85f,
                        yPct = 8f,
                        binding = TouchBindings.BTN_REAR_VIEW,
                        label = "R",
                        sizeMult = 0.7f,
                    ),
                ),
            ...
            radialMenus =
                listOf(
                    guidebotWheel(10f, 20f),
                    primaryWeaponWheel(40f, 8f),
                    secondaryWeaponWheel(60f, 8f),
                ),
        )
    ...
    fun presetClaw() =
        TouchLayout(
            ...
            buttons =
                listOf(
                    ...
                    ButtonControl(
                        ...
                        xPct = 10f,
                        yPct = 12f,
                        binding = TouchBindings.BTN_SLIDE_ON,
                        label = "SL",
                        toggle = true,
                    ),
                    ButtonControl(
            ...
            radialMenus =
                listOf(
                    guidebotWheel(30f, 5f),
                    primaryWeaponWheel(50f, 5f),
                    secondaryWeaponWheel(70f, 5f),
                ),
    ...
    private fun guidebotWheel(
        ...
        sizeMult = 1f,
        centerLabel = "Clear",
        centerBinding = KeyEvent.KEYCODE_0,
        segments =
            listOf(
    ...
    private fun primaryWeaponWheel(
        xPct: Float,
        yPct: Float,
    ) = RadialMenuControl(
        id = "PriWpn",
    ...
    private fun secondaryWeaponWheel(
        xPct: Float,
        yPct: Float,
    ) = RadialMenuControl(
        id = "SecWpn",
