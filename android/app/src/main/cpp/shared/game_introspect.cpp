...
static json serialize_guidebot()
{
	...
	const auto serialize_shadow_decision = [](
		...
		return json{
			...
			{ "requires_guided_missile", decision.requires_guided_missile != 0 },
	...
	result["route_goal_frontier_player_openable_door"] =
	    (bool) escort_get_route_goal_frontier_player_openable_door();
	...
	result["route_decision"] = route_decision_available
	                               ? json{
		                                 ...
		                                 { "requires_guided_missile", route_decision.requires_guided_missile != 0 },
	...
	j["automap_active"] = (bool) Automap_active;
	{
		...
		if (automap_get_view_info(&avi)) {
			...
			json automap = {
				...
				{ "objective_overlay_mode", avi.objective_overlay_mode },
				{ "objective_overlay_mode_name", level_metadata_objective_mode_name(avi.objective_overlay_mode) },
				{ "objective_visible_step_count", avi.objective_visible_step_count },
