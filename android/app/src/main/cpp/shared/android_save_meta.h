...
#define ANDROID_SAVE_META_THUMB_W          200
#define ANDROID_SAVE_META_THUMB_H          100
...
enum {
	...
	ANDROID_SAVE_META_KIND_AUTO_ABORT = 4,
	ANDROID_SAVE_META_KIND_AUTO_PERIODIC = 5
};

enum {
	ANDROID_SAVE_META_SLOT_QUICK = 3,
	ANDROID_SAVE_META_SLOT_AUTO_PERIODIC_A = 4,
	ANDROID_SAVE_META_SLOT_AUTO_PERIODIC_B = 5,
	ANDROID_SAVE_META_SLOT_AUTO_ABORT = 6,
	ANDROID_SAVE_META_SLOT_AUTO_PROGRESS = 7,
	ANDROID_SAVE_META_SLOT_AUTO_EXIT = 8,
	ANDROID_SAVE_META_SLOT_AUTO_MINIMIZE = 9
};

#define ANDROID_SAVE_DESC_AUTO_MINIMIZE "[auto] save"
#define ANDROID_SAVE_DESC_AUTO_EXIT     "[auto] exit"
#define ANDROID_SAVE_DESC_AUTO_ABORT    "[auto] abort"
#define ANDROID_SAVE_DESC_AUTO_PROGRESS "[auto] best"
#define ANDROID_SAVE_DESC_AUTO_PERIODIC "[auto] 5min"
