...
#ifndef NET_UDP_ANDROID_RESTORE_HOST_ADDR_PLAYER_INDEX
#error NET_UDP_ANDROID_RESTORE_HOST_ADDR_PLAYER_INDEX must be defined before including net_udp_android_autonet_shared.h
#endif
