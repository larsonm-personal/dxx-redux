...
function(dxx_input_demo_prepare_codec_deps)
	if(NOT TARGET input_demo_picosha2)
		...
		target_include_directories(input_demo_picosha2 INTERFACE ${input_demo_picosha2_src_SOURCE_DIR})
	endif()
	...
	if(NOT TARGET input_demo_cpp_base64)
		FetchContent_Declare(
			...
			GIT_TAG        951de609dbe27ce8864dfe47323c4ade96bee86e
			GIT_SHALLOW    TRUE
		)
		FetchContent_MakeAvailable(input_demo_cpp_base64_src)
		add_library(input_demo_cpp_base64 STATIC
			${input_demo_cpp_base64_src_SOURCE_DIR}/base64.cpp)
		target_compile_features(input_demo_cpp_base64 PUBLIC cxx_std_11)
		target_include_directories(input_demo_cpp_base64 PUBLIC ${input_demo_cpp_base64_src_SOURCE_DIR})
	endif()
endfunction()
