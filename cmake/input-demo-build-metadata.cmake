...
function(dxx_input_demo_get_build_metadata out_build_number out_git_version)
    ...
    elseif(GIT_FOUND)
        execute_process(
            COMMAND "${GIT_EXECUTABLE}" rev-list --count HEAD WORKING_DIRECTORY "${repo_root}"
    ...
    elseif(GIT_FOUND)
        execute_process(
            COMMAND "${GIT_EXECUTABLE}" rev-parse --short HEAD WORKING_DIRECTORY "${repo_root}"
            OUTPUT_VARIABLE git_short_hash OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
