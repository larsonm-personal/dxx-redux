...
#
# Search order: 1. ANDROID_NDK_ROOT / ANDROID_NDK environment variables (standard) 2. NDK_ROOT
# environment variable 3. Newest android-ndk-* folder under dependency_base.txt dir (or C:/local
# fallback) 4. Common SDK locations (<SDK>/ndk/<version> and <SDK>/ndk-bundle) 5. Common standalone
# install locations
#
# Usage from Gradle / CMake: include(${CMAKE_CURRENT_LIST_DIR}/../cmake/ndk-auto.cmake) -- after
# return, ANDROID_NDK is set if found.
...
# 1. Scan dependency base dir for newest android-ndk-* folder (Windows)
...
# 1. SDK-relative paths (ANDROID_HOME / ANDROID_SDK_ROOT)
...
# 1. Common standalone install locations
if(NOT _NDK_ROOT)
    if(WIN32)
...
if(_NDK_ROOT)
    ...
    message(WARNING "ndk-auto: Android NDK not found. Install the NDK and either:\n"
