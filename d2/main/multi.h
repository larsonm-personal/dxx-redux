...
#ifdef __ANDROID__
#define MULTI_PROTO_VERSION 30078 // Asset identity before level/object sync
#define MULTI_PLAYER_DROP_LENGTH 114
#define MULTI_SHIP_STATUS_LENGTH 84
#define MULTI_COOP_RESTORE_LENGTH 102
#else
#define MULTI_PROTO_VERSION 30025 // Asset identity before level/object sync
...
#define for_each_multiplayer_command(BEFORE,VALUE,AFTER)	\
	...
	VALUE(MULTI_DOOR_OPEN            , 6)	/* last byte: destroying player, or -1 for state sync */ \
	...
	VALUE(MULTI_COOP_RESTORE_STATUS  , 6)   \
