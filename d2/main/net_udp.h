#ifndef DXX_D2_MAIN_NET_UDP_H
#define DXX_D2_MAIN_NET_UDP_H
...
#define UPID_GAME_INFO_SIZE			(6 + 4*2 + 369 + (NETGAME_NAME_LEN+1) + (MISSION_NAME_LEN+1) + ((MAX_PLAYERS+4)*(CALLSIGN_LEN+1+37)) + 20*12)
