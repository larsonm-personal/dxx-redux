...
#define D1_MAC_SHARE_MISSION_HOGSIZE2   3387843
#define IS_D1_SHAREWARE_MISSION_HOGSIZE(size) ((size) == D1_SHAREWARE_MISSION_HOGSIZE || (size) == D1_SHAREWARE_10_MISSION_HOGSIZE || (size) == D1_MAC_SHARE_MISSION_HOGSIZE || (size) == D1_MAC_SHARE_MISSION_HOGSIZE2)
#define IS_D1_MAC_MISSION_HOGSIZE(size) ((size) == D1_MAC_SHARE_MISSION_HOGSIZE || (size) == D1_MAC_SHARE_MISSION_HOGSIZE2 || (size) == D1_MAC_MISSION_HOGSIZE)
