...
extern unsigned int escort_get_route_notification_coalesced_count(void);
extern unsigned int escort_get_route_redundant_dirty_domain_count(void);
extern unsigned int escort_get_route_event_coalesced_rescan_count(void);
extern unsigned int escort_get_route_publish_latency_sample_count(void);
extern unsigned int escort_get_route_publish_latency_last_ticks(void);
extern unsigned int escort_get_route_publish_latency_max_ticks(void);
extern unsigned int escort_get_route_ignored_nonowner_event_count(void);
extern unsigned int escort_get_route_pending_audit_mask(void);
extern unsigned int escort_get_route_audit_check_count(void);
extern unsigned int escort_get_route_audit_discovery_count(void);
...
extern unsigned int escort_get_route_certificate_work_max(void);
extern unsigned int escort_get_route_path_retained_count(void);
extern unsigned int escort_get_route_path_replaced_count(void);
extern unsigned int escort_get_route_invalid_path_stopped_count(void);
...
extern fix64 escort_get_navigation_liveness_age(void);
...
#ifdef INTROSPECT_ON
extern void escort_reset_route_efficiency_counters(void);
extern void escort_set_route_notifications_suppressed(int suppressed);
extern int escort_get_route_notifications_suppressed(void);
extern void escort_set_route_certificate_checks_suppressed(int suppressed);
extern int escort_get_route_certificate_checks_suppressed(void);
...
extern void escort_recall_to_ship(void);
