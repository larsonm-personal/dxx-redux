...
#ifdef __ANDROID__
extern int wclip_read_n_d1(wclip *wc, int n, rewind_file *fp);
#else
 ...
 */
#ifdef __ANDROID__
extern void wall_read_n_swap(wall *w, int n, int swap, rewind_file *fp);
#else
 ...
 */
#ifdef __ANDROID__
void cloaking_wall_read_n_swap(cloaking_wall *cw, int n, int swap, rewind_file *fp);
#else
