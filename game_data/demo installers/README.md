...
The Mac demo packages are StuffIt 5 archives. `Descent Shareware.sit` contains the D1 game data directly. `Descent II Preview.sit` contains a Mac installer application; its data fork is an STi archive containing the D2 demo data files.
