...
#define MULTI_PROTO_VERSION 30012 // Redux 1.2 + full death spew + persistent player spew + Android host-authoritative rewind save transfer + coop difficulty changes
