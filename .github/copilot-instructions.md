...
- use the automation api to drive the game into a desired state for testing. when using the automation api, save new automation scripts to android/game_scripts/*.json so they can be maintained and committed to git. eventually they'll be used for regression testing
